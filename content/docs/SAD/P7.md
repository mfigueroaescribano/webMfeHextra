...
Trabajaremos con el mismo escenario que el montado para el apartado de OpenVPN site-to-site.
...
Clave pública: `NFqze6bXk6GaAn6mv6vJrq1Kz1jgrfs5tYJgxyKmCDg=`

Clave privada: `eHWxTeuV0j4zuhgiCHK+kuN68E4EnkpujDMieG2OVEY=`
...
Address = 10.99.99.1
ListenPort = 51820
PrivateKey = eHWxTeuV0j4zuhgiCHK+kuN68E4EnkpujDMieG2OVEY=
```
...
Clave pública: `eoiefjOnlCLmjd9l0Ki2z+ZD/PVfMVMwoGHSlaLPfmc=`

Clave privada: `uHcBexSV52Mdhz/1ye+Hv6ISS8NdyhL4POuxvmy75mM=`
...
[Interface]
Address = 10.99.99.2
PrivateKey = uHcBexSV52Mdhz/1ye+Hv6ISS8NdyhL4POuxvmy75mM=
ListenPort = 51820

[Peer]
PublicKey = NFqze6bXk6GaAn6mv6vJrq1Kz1jgrfs5tYJgxyKmCDg=
AllowedIPs = 0.0.0.0/0
Endpoint = 130.27.1.12:51820
...
```
[Peer]
Publickey = eoiefjOnlCLmjd9l0Ki2z+ZD/PVfMVMwoGHSlaLPfmc=
AllowedIPs = 0.0.0.0/0
PersistentKeepAlive = 25
Endpoint = 130.2.2.2:51820
